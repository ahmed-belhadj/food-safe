...
window.App = {
  ...
  createContract: function() {
    foodSafeContract
      .deploy({ data: foodSafeCode })
      .send({ from: account, data: foodSafeCode, gas: 3000000 })
  ...
  addNewLocation: function() {
    ...
    var encryptedSecret = CryptoJS.AES.encrypt(
      locationSecret,
      passPhrase
    ).toString();
    deployedFoodSafe.methods
      ...
      .then(function(trailCount) {
        deployedFoodSafe.methods
          ...
          .then(function(returnValues) {
            ...
            var decryptedSecret = CryptoJS.AES.decrypt(
              encryptedSecret,
              passPhrase
